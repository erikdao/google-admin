    ...
    >
      <div className="flex items-center justify-center min-h-screen p-4 text-cetner">
        ...
        <div className="inline-block z-10 bg-white rounded text-left overflow-hidden shadow-xl max-w-1/2 w-1/3">
          <Dialog.Title className="w-100 py-4 px-6 bg-blue-500 text-lg text-white font-bold">Add new user</Dialog.Title>
          <div className="px-6 mb-2 mt-2">
            ...
            <div className="mt-1">
              <input
                ...
                className="shadow-sm focus:ring-blue-500 focus:border-blue-400 block w-full sm:text-sm rounded-md outline-none border-2 border-gray-300 px-3 py-2"
                placeholder="John"
              />
            </div>
          </div>
          ...
          <div className="px-6 mb-2">
            ...
            <div className="mt-1 flex">
              <input
                ...
                id="email"
                autoComplete="given-name"
                className="shadow-sm focus:ring-blue-500 focus:border-blue-400 block w-full sm:text-sm rounded-none rounded-l-md outline-none border-2 border-gray-300 px-3 py-2"
          ...
          <div className="py-4 px-6 mt-2 flex items-start flex-row-reverse border-t-1 border-gray-500">
            <button
              type="button"
              className="w-full inline-flex justify-center rounded-md border boder-transparent shadow-sm px-4 py-2 bg-blue-500 font-medium text-white hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ml-3 sm:w-auto"
            >
              Create
            </button>
            <button
